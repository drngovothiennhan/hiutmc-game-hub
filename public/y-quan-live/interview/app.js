...
function header() {
  return `<header class="iq-header"><a class="iq-back" href="${gameHubPath('y-quan-live/')}?v=${Y_QUAN_ROUTE_VERSION}">← Về Y Quán</a><div><span class="iq-kicker">HIU TMC · KHU LUYỆN TẬP</span><h1>Luyện vấn chẩn Thập vấn</h1></div><span class="beta-tag">BẢN TRẢI NGHIỆM</span></header>${nav()}`;
}
function doctorCard() {
